...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        public float obstactDistance = 0.2f;
        ...
        public bool CheckForObstacle(float forwardDistance)
        {
            ...
            if (Physics2D.CircleCast(m_Collider.bounds.center, m_Collider.bounds.extents.y - 0.2f, m_SpriteForward * obstactDistance, forwardDistance, m_Filter.layerMask.value))
            {
                return true;
            }

            Vector3 castingPosition = (Vector2)(transform.position + m_LocalBounds.center) + (m_SpriteForward * obstactDistance) * m_LocalBounds.extents.x;
