...
namespace Gamekit2D
{
    public class ScreenFader : MonoBehaviour
    {
        ...
        public static IEnumerator FadeSceneIn ()
        {
            ...
            else if (Instance.endCanvasGroup.alpha > 0.1f)
                canvasGroup = Instance.endCanvasGroup;
            else
            ...
            Instance.endCanvasGroup.gameObject.SetActive(false);
        }
